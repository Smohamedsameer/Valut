const friends = {
  ...
  mujeeb: {
    ...
    password: "cool lip",
    dob: "2002/02/03", // YYYY-MM-DD
     photo: "muj.jpg",
    wish: "Happy Birthday Rahman 🎉 May all your dreams come true!",
    memories: "From madarasa days to late night talks, every memory with you is gold ❤️.",
 ...
 memories5:"Your circle shapes your future : Choose friends who push you forward, not habits that pull you back.",
  memories6:"Midnight cooking fried rice with tea at 1 a.m. — no permission, only courage 😄.Silent laughter in the hostel kitchen, praying no usthads , ameen appears ",
